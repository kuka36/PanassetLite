    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (showAdjustment && initialAsset) {
            ...
            addTransaction({
                ...
                date: dateAcquired, // Use the refresh time set by user
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden flex flex-col max-h-[90vh]">
                            ...
                            <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-4">
                                ...
                                {showAdjustment && (
                                    <div className="bg-blue-50 p-3 rounded-lg border border-blue-100 mb-2 animate-fade-in">
                                        <label className="block text-xs font-bold text-blue-700 uppercase mb-1">{t('newCorrectQuantity')}</label>
                                        <input
                                            type="number" step="any"
                                            placeholder={t('enterActualQuantity')}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="col-span-2">
                                        <label className="block text-xs font-medium text-slate-500 uppercase mb-1">
                                            {showAdjustment ? t('dateRefreshed') : t('dateAcquired')}
                                        </label>
                                    ...
                                    <div>
                                        <label className="flex items-center justify-between text-xs font-medium text-slate-500 uppercase mb-1">
                                            ...
                                            {initialAsset && !showAdjustment && (
                                                ...
                                                >
                                                    <PenLine size={10} /> {t('adjustButton')}
                                                </button>
                                            )}
                                        </label>
                                        <input
                ...
                {(step === 2 || initialAsset) && (
                    <div className="p-6 pt-0 bg-white shrink-0">
                        ...
                        >
                            <Save size={18} />
                            {showAdjustment ? t('confirmAdjustment') : (initialAsset ? t('saveChanges') : t('addToPortfolio'))}
                        </button>
                    </div>
                )}
            </div>
